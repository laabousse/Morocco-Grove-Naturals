      ...
      >
        ...
        <div className="space-y-4 mb-8 text-left text-gray-600">
          <p>
            ...
            and will ship it shortly. A confirmation email with your order
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-2">
          ...
          <ul className="text-green-700 text-sm space-y-1">
            ...
            <li>We will notify you once your order has shipped</li>{" "}
            <li>You can track the status of your order at any time</li>{" "}
          </ul>
        </div>
